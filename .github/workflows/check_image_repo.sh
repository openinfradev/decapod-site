...
# VALIDATE_TARGET_REPO='harbor-cicd.taco-cat.xyz/tks'
VALIDATE_TARGET_REPO='tks'
EXCEPTION_LIST='quay.io/argoproj/workflow-controller:v3.2.6,quay.io/argoproj/argocli:v3.2.6,docker.io/bitnami/postgresql:15.1.0-debian-11-r0,appscode/kubed:v0.12.0-rc.3,quay.io/bitnami/sealed-secrets-controller:v0.16.0,k8s.gcr.io/provider-aws/aws-ebs-csi-driver:v1.5.1,k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.1.0,k8s.gcr.io/sig-storage/livenessprobe:v2.4.0,k8s.gcr.io/provider-aws/aws-ebs-csi-driver:v1.5.1,k8s.gcr.io/sig-storage/csi-provisioner:v2.1.1,k8s.gcr.io/sig-storage/csi-attacher:v3.1.0,k8s.gcr.io/sig-storage/csi-snapshotter:v3.0.3,k8s.gcr.io/sig-storage/csi-resizer:v1.1.0,k8s.gcr.io/sig-storage/livenessprobe:v2.4.0,k8s.gcr.io/autoscaling/cluster-autoscaler:v1.22.2,k8s.gcr.io/ingress-nginx/controller:v1.1.1@sha256:0bc88eb15f9e7f84e8e56c14fa5735aaa488b840983f87bd79b1054190e660de,k8s.gcr.io/ingress-nginx/kube-webhook-certgen:v1.1.1@sha256:64d8c73dca984af206adf9d6d7e46aa550362b1d7a01f3a0a91b20cc67868660,k8s.gcr.io/ingress-nginx/kube-webhook-certgen:v1.1.1@sha256:64d8c73dca984af206adf9d6d7e46aa550362b1d7a01f3a0a91b20cc67868660,appscode/kubed:v0.12.0,calico/node:v3.15.5,calico/cni:v3.15.5,calico/cni:v3.15.5,calico/pod2daemon-flexvol:v3.15.5,calico/kube-controllers:v3.15.5,rancher/local-path-provisioner:v0.0.22,k8s.gcr.io/metrics-server/metrics-server:v0.6.1' # except lma and service-mesh
